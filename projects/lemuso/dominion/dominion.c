...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
      playMine(choice1, choice1, handPos, currentPlayer, state);
      return 0; 
    ...
    case baron:
      playBaron(currentPlayer, choice1, state); 
      return 0;
    ...
    case minion:
      playMinion(choice1,choice2, currentPlayer, handPos, state); 
      return 0;
    ...
    case tribute:
      playTribute(&tributeRevealedCards[1], currentPlayer, nextPlayer, state); 
      return 0; 
